...
namespace tmoe {
    ...
    LaunchContext CliParser::parse(const std::vector<std::string_view> &pos_args) {
        ...
        if (pos_args.size() > 1) {
            ...
            else if (arg2 == "r" || arg2 == "rasp" || arg2 == "raspios" || arg2 == "raspbian")
                ctx.distro_name = "raspios";
            ...
            else if (arg2 == "xs" || arg2 == "xsdl" || arg2 == "xserver" || arg2 == "startxsdl")
                ctx.exec_program = "startxsdl";
        ...
        if (pos_args.size() > 2) {
            ...
            else if (arg3 == "xs" || arg3 == "xsdl" || arg3 == "xserver" || arg3 == "startxsdl")
                ctx.exec_program = "startxsdl";
        ...
        if (pos_args.size() > 3) {
            ...
            else if (arg4 == "xs" || arg4 == "xsdl" || arg4 == "xserver" || arg4 == "startxsdl")
                ctx.exec_program = "startxsdl";
        ...
        if (pos_args.size() > 4) {
            ...
            else if (arg5 == "x" || arg5 == "xs" || arg5 == "xsdl" || arg5 == "xserver" || arg5 == "startxsdl")
                ctx.exec_program = "startxsdl";
