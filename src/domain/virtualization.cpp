...
namespace tmoe::domain {
    ...
    void VirtualizationManager::run_iso_menu() {
        while (true) {
            ...
            switch (std::stoi(choice)) {
                case 1: download_alpine_iso();
                    break;
                case 2: download_android_x86_iso();
                    break;
                case 3: download_debian_iso();
                    break;
                case 4: download_ubuntu_iso();
                    break;
                case 5: download_windows_iso();
                    break;
                case 6: download_lmde_iso();
                    break;
                default: break;
            }
            Logger::press_enter();
    ...
    void VirtualizationManager::download_alpine_iso() {
        ...
        switch (std::stoi(ed_choice)) {
            case 1: edition = "standard";
                break;
            case 2: edition = "extended";
                break;
            case 3: edition = "virt";
                break;
            case 4: edition = "xen";
    ...
    void VirtualizationManager::download_debian_iso() {
        ...
        switch (ac) {
            case 1: grep_arch = "amd64";
                is_nonfree = true;
                break;
            case 2: grep_arch = "i386";
                is_nonfree = true;
                break;
            case 3: grep_arch = "amd64";
                is_free_menu = true;
                break;
            case 4: grep_arch = "i386";
                is_free_menu = true;
                break;
            case 5: grep_arch = "arm64";
                break;
            case 6: grep_arch = "armhf";
                break;
            case 7: grep_arch = "mips";
                break;
            case 8: grep_arch = "mipsel";
                break;
            case 9: grep_arch = "mips64el";
                break;
            case 10: grep_arch = "ppc64el";
                break;
            case 11: grep_arch = "s390x";
                break;
            default: return;
        }
