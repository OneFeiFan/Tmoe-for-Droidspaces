...
struct DdeDesktop : DesktopBase {
    explicit DdeDesktop(const TmoeConfig& c) : DesktopBase(c), info_(gui_config::all_desktops()[9]) {}
    ...
    void will_be_installed_message() const override { Logger::info("DDE: startdde / dde-launcher"); }
