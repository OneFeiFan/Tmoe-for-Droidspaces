...
void BetaFeaturesManager::run_system_menu() {
    while (true) {
        ...
        switch (std::stoi(ch)) {
        case 1:  placeholder_return("sudo user group management"); break;
        case 2:  placeholder_return("rc.local systemd script");   break;
        case 3:  placeholder_return("UEFI boot manager");          break;
        ...
        case 6:
            ...
            break;
        case 7:  placeholder_return("boot-repair (ppa:yannubuntu)"); break;
        case 8:  // neofetch
...
void BetaFeaturesManager::run_store_menu() {
    while (true) {
        ...
        case 1:
            ...
            break;
        case 2: run_deepin_menu(); break;
        case 3: PackageManager::install("gnome-software", family); break;
        case 4: {
        ...
        case 7:
            ...
            break;
        case 8: PackageManager::install("qbittorrent", family); break;
        default: break;
        }
        Logger::press_enter();
    }
...
void BetaFeaturesManager::run_network_menu() {
    while (true) {
        ...
        switch (std::stoi(ch)) {
        case 1:  placeholder_return("nmtui (NetworkManager TUI)"); break;
        case 2:  placeholder_return("enable network device");      break;
        case 3:  placeholder_return("WiFi scan (iw/iwlist)");      break;
        case 4:  placeholder_return("network device status");      break;
        case 5:  placeholder_return("network card driver install"); break;
        case 6:  placeholder_return("view IP address");            break;
        case 7:  placeholder_return("WiFi QR code");               break;
        case 8:  placeholder_return("edit network config");        break;
        case 9:  placeholder_return("systemctl enable NetworkManager"); break;
        case 10:
            // blueman
        ...
        case 1:
            // OBS Studio — Gentoo特殊包名
            {
                std::string obs_pkg = (cfg_.linux_distro == "gentoo")
                    ? "media-video/obs-studio" : "obs-studio";
                PackageManager::install(obs_pkg, family);
            }
            break;
        case 2:  PackageManager::install("seahorse", family); break;
        case 3:
            PackageManager::install({"kodi", "kodi-wayland"}, family);
            break;
        case 4:  run_scrcpy_menu(); break;
        case 5:  PackageManager::install("flameshot", family); break;
        case 6:  PackageManager::install("telegram-desktop", family); break;
        default: break;
        }
        Logger::press_enter();
    }
...
void BetaFeaturesManager::run_scrcpy_menu() {
    while (true) {
        ...
        case 2: placeholder_return("adb connect (interactive address input)"); break;
        case 3: placeholder_return("switch scrcpy device (adb devices list)"); break;
        case 4:
            Executor::passthrough("adb kill-server 2>/dev/null || true");
            Executor::passthrough("adb devices -l 2>/dev/null || true");
            break;
        case 5: placeholder_return("scrcpy FAQ / readme"); break;
        default: break;
        }
        Logger::press_enter();
    }
