        ...
        while (running) {
            ...
            switch (std::stoi(choice)) {
                case 0:
                    ...
                    break;
                case 1:
                    Executor::passthrough("nmtui 2>/dev/null || true");
                    break;
                case 2:
                    enable_network_device();
                    break;
                case 3:
                    wifi_scan();
                    break;
