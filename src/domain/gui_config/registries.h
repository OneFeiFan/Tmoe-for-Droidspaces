...
namespace gui_config {
    ...
    inline const std::vector<DesktopInfo>& all_desktops() {
        static const std::vector<DesktopInfo> reg = {
            // ── 完整桌面环境 ──
            {"xfce", "🐭 Xfce", "🐭", "xfce4-session", "startxfce4", "lightdm", false, false, "xfce4 xfce4-goodies", "兼容性高,简单优雅"},
            {"xfce-lite", "Xfce Lite", "", "xfce4-session", "startxfce4", "lightdm", false, false, "xfce4 xfce4-terminal xfce4-panel thunar", "精简安装,未美化"},
            {"lxqt", "🐦 LXQt", "🐦", "lxqt-session", "startlxqt", "sddm", false, false, "lxqt lxqt-qtplugin", "LXDE团队基于Qt开发"},
            {"lxde", "🕊 LXDE", "🕊", "lxsession", "startlxde", "lightdm", false, false, "lxde lxde-common", "轻量化桌面,资源占用低"},
            {"mate", "🌿 MATE", "🌿", "mate-session", "mate-panel", "lightdm", false, false, "mate-desktop-environment", "GNOME2的延续,舒适体验"},
            {"kde", "🦖 KDE Plasma", "🦖", "startplasma-x11", "startkde", "sddm", false, false, "kde-plasma-desktop", "风格华丽,功能丰富"},
            {"cinnamon", "🌲 Cinnamon", "🌲", "cinnamon-session", "cinnamon", "lightdm", true, false, "cinnamon-desktop-environment", "基于GNOME,对用户友好"},
            {"gnome", "👣 GNOME", "👣", "gnome-session", "gnome-shell-x11", "gdm", true, false, "gnome-session gnome-shell", "GNU网络对象模型环境"},
            {"budgie", "🦜 Budgie", "🦜", "budgie-desktop", "budgie-panel", "lightdm", true, false, "budgie-desktop", "虎皮鹦鹉,基于GNOME"},
            {"dde", "🐋 Deepin DDE", "🐋", "startdde", "dde-launcher", "lightdm", true, false, "dde dde-desktop", "国产精美桌面"},
            {"deepin", "🐳 Deepin", "🐳", "deepin-session", "deepin-launcher", "lightdm", true, false, "deepin-desktop-environment deepin-terminal", "Deepin完整桌面"},
            {"ukui", "🐱 UKUI", "🐱", "ukui-session", "ukui-panel", "lightdm", true, false, "ukui-desktop-environment", "优麒麟桌面,简洁流畅"},
            {"cutefish", "🐟 Cutefish", "🐟", "cutefish-session", "cutefish-launcher", "lightdm", true, false, "cutefish", "简洁美观的现代化桌面"},
            // ── 窗口管理器 ──
            {"icewm", "❄ IceWM", "", "icewm-session", "icewm", "", false, true, "icewm icewm-common", "意在提升感观和体验"},
            {"openbox", "📦 Openbox", "", "openbox-session", "openbox", "", false, true, "openbox obconf obmenu", "快速,轻巧,可扩展", {{"debian", "openbox openbox-menu"}}},
            {"fvwm", "🪶 FVWM", "", "fvwm", "fvwm", "", false, true, "fvwm fvwm-icons", "强大的ICCCM2兼容WM", {{"debian", "fvwm fvwm-icons"}}},
            {"awesome", "🚀 Awesome", "", "awesome", "awesome", "", false, true, "awesome", "平铺式WM", {{"debian", "awesome awesome-extra"}}},
            {"enlightenment", "💡 Enlightenment", "", "enlightenment", "enlightenment", "", false, true, "enlightenment", "X11 WM based on EFL"},
            {"fluxbox", "📐 Fluxbox", "", "fluxbox", "fluxbox", "", false, true, "fluxbox", "高度可配置,低资源占用", {{"debian", "bbmail bbpager bbtime fbpager fluxbox"}}},
            {"i3", "🧩 i3", "", "i3", "i3", "", false, true, "i3 i3status i3lock dmenu", "改进的动态平铺WM", {{"debian", "i3 i3-wm i3blocks"}, {"alpine", "i3wm"}}},
            {"xmonad", "λ XMonad", "", "xmonad", "xmonad", "", false, true, "xmonad xmobar", "基于Haskell的平铺式WM", {{"debian", "xmobar dmenu xmonad"}}},
            ...
            {"blackbox", "⬛ Blackbox", "", "blackbox", "blackbox", "", false, true, "blackbox", "WM for X", {{"debian", "bbmail bbpager bbtime blackbox"}}},
            ...
            {"herbstluftwm", "🌳 herbstluftwm", "", "herbstluftwm", "herbstluftwm", "", false, true, "herbstluftwm", "manual tiling WM for X11"},
            {"jwm", "🫙 JWM", "", "jwm", "jwm", "", false, true, "jwm", "very small & pure轻量纯净"},
            {"kwin", "🪟 KWin", "", "kwin_x11", "kwin_x11", "", false, true, "kwin-x11", "KDE默认WM,X11 version", {{"alpine", "kwin"}}},
            {"lwm", "🪶 LWM", "", "lwm", "lwm", "", false, true, "lwm", "轻量化WM"},
            {"marco", "🪟 Marco", "", "marco", "marco", "", false, true, "marco", "轻量化GTK+ WM for MATE"},
            {"matchbox", "📱 Matchbox", "", "matchbox-window-manager", "matchbox-window-manager", "", false, true, "matchbox-window-manager", "低配机福音", {{"debian", "matchbox-themes-extra matchbox-window-manager"}}},
            {"miwm", "🧱 MIWM", "", "miwm", "miwm", "", false, true, "miwm", "microscopic WM"},
            {"muffin", "🧁 Muffin", "", "muffin", "muffin", "", false, true, "muffin", "Cinnamon默认WM", {{"debian", "murrine-themes muffin"}}},
            {"mwm", "🧱 MWM", "", "mwm", "mwm", "", false, true, "mwm", "Motif Window Manager"},
            {"oroborus", "🪟 Oroborus", "", "oroborus", "oroborus", "", false, true, "oroborus", "轻量WM for X11"},
            {"pekwm", "🧱 PekWM", "", "pekwm", "pekwm", "", false, true, "pekwm", "轻量WM", {{"debian", "pekwm-themes pekwm"}}},
            ...
            {"sawfish", "🐟 Sawfish", "", "sawfish", "sawfish", "", false, true, "sawfish", "可扩展WM", {{"debian", "sawfish-themes sawfish"}}},
            ...
            {"exwm", "🧙 Emacs EXWM", "", "emacs-gtk", "emacs-gtk", "", false, true, "elpa-exwm emacs-gtk", "Emacs X Window Manager"},
        };
        return reg;
    }
